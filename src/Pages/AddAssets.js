...
function AddAssets() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'Link_ID') {
      // Check if the Link_ID already exists
      if (existingLinkIDs.includes(value)) {
        isValid = false;
        // Show SweetAlert for duplicate Link_ID
        Swal.fire({
          title: 'Error!',
  ...
  if (isAnyFieldEmpty) {
    ...
    try {
      const response = await fetch('http://localhost:7000/api/addAssets', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        // Successful submission, you can handle the response as needed
    ...
    Swal.fire({
      ...
      // Reset the form data after the user clicks "OK"
            ...
            <ul className="navbar-nav">
              <li className="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 className="welcome-text">
                  Good Morning,{" "}
                  <span className="text-black fw-bold">Admin</span>
                </h1>
            ...
            <ul className="nav">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/OpenTicket">
                  ...
                  <span className="menu-title">Open Tickets</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/MyAssets">
                  <i className="menu-icon mdi mdi-chart-line" />
                  <span className="menu-title">My Assets</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="">
                  ...
                  <span className="menu-title">Problem Code</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="">
            ...
            <footer className="footer">
              <div className="d-sm-flex justify-content-center justify-content-sm-between">
                <span className="text-muted text-center text-sm-left d-block d-sm-inline-block">
                  Big <a target="_blank">CRM Web Application</a> from XSOL DATA
                  SYSTEM PVT LTD
                </span>
